package cleancodebook.myimplementation.chapter10.refactored;

import clean.code.myimplementation.added.to.make.code.build.Column;
import clean.code.myimplementation.added.to.make.code.build.Criteria;
